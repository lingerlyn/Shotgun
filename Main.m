...
neuron_type='sign'  ; %'logistic'or 'linear' or 'sign'
...
glasso=1; %use glasso?
restricted_penalty=1; % use a restricted l1 penality in lasso (only on parts of the inv_COV matrix)?
...
est_priors.ss2=.05*ones(N);
est_priors.noise_var=.09*ones(N,1);
est_priors.a=.2*ones(N);
